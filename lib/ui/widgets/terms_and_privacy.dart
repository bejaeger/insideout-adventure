...
void showTermsAndPrivacyDialog(
  ...
  return showAboutDialog(
    ...
    children: [
      Text(
          "By using our app, you agree to the following terms and privacy policy"),
      verticalSpaceMedium,
      ...
      Text(
        ...
        """
1. Introduction
Welcome to InsideOut Adventure! Our app incentivizes healthy activities and outdoor exploration while allowing parents to manage their child’s screen time.
...
If you have any questions or concerns, please reach out via our in-app feedback function, or directly to our temporary email address [patrick.mayerhofer@icloud.com](mailto:patrick.mayerhofer@icloud.com).
""",
        style: bodyStyle,
      ),
      verticalSpaceMedium,
...
If you have any questions or concerns about our Privacy Policy, please contact us via our in-app feedback function or directly to our temporary email address [patrick.mayerhofer@icloud.com](mailto:patrick.mayerhofer@icloud.com)
""",
        style: bodyStyle,
      ),
    ],

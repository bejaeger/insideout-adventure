...
import 'package:afkcredits/ui/custom_dialogs/super_user_settings/super_user_settings_dialog_view.dart';
...
void setupDialogUi() {
  ...
  final builders = {
    ...
    DialogType.SuperUserSettings: (context, sheetRequest, completer) =>
        SuperUserSettingsDialogView(request: sheetRequest, completer: completer),
